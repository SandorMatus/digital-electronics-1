...
entity driver_7seg_8digits is
    port(
        clk     : in  std_logic;
        reset   : in  std_logic;
        data0_i : in  std_logic_vector(1 downto 0);
        data1_i : in  std_logic_vector(1 downto 0);
        data2_i : in  std_logic_vector(1 downto 0);
        data3_i : in  std_logic_vector(1 downto 0);
        data4_i : in  std_logic_vector(1 downto 0);
        data5_i : in  std_logic_vector(1 downto 0);
        data6_i : in  std_logic_vector(1 downto 0);
        data7_i : in  std_logic_vector(1 downto 0);
